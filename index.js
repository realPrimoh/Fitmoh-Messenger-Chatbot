    ...
    request(
      {
        ...
        method: "POST",
        qs: {
          key: process.env.googleVisionApiKey || keys.googleVisionApiKey || null
        },
        json: true,
        body: {
          requests: [
          ...
          message: {
            attachment: {
              ...
              payload: {
                ...
                elements: [
                  {
                    title: "Fitmoh - food analysis by image",
                    image_url:
                      "https://s3.amazonaws.com/fitmoh/fitmoh.png",
                    buttons: [
                      {
                        type: "element_share",
                        share_contents: {
                          attachment: {
                            ...
                            payload: {
                              ...
                              elements: [
                                {
                                  title:
                                    "Fitmoh - food analysis by image",
                                  image_url:
                                    "https://s3.amazonaws.com/Fitmoh/fcb_logo.png",
                                  default_action: {
                                    type: "web_url",
                                    url:
                                      "---"
